...
public interface UserRoleRepository extends JpaRepository<UmmtUserRoleMst, Long> {
    ...
    List<UmmtUserRoleMst> findByGnumUserIdAndGblIsvalid(Long gnumUserId, Integer gblIsvalid);
    ...
    List<UmmtUserRoleMst> findMappedRoles(@Param("gnumUserId") Long gnumUserId, @Param("gblIsvalid") Integer gblIsvalid, @Param("gnumIsDefault") Integer gnumIsDefault, @Param("gnumRoleId") Integer gnumRoleId);
}
