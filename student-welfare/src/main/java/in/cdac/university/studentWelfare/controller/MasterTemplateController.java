...
import in.cdac.university.studentWelfare.service.MasterTemplateService;
import in.cdac.university.studentWelfare.util.ComboUtility;
...
@RestController
@RequestMapping("/sw/masterTemplate")
