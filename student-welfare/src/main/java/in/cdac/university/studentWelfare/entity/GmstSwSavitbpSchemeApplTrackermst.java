...
@Getter
@Setter
@IdClass(GmstSwSavitbpSchemeApplTrackermstPK.class)
@Entity
@Table(name="gmst_sw_savitbp_scheme_appl_trackermst", schema = "sw")

public class GmstSwSavitbpSchemeApplTrackermst {
